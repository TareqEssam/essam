...
const SemanticBrain = {
    ...
    "قرار": ["قانون", "لائحة", "تشريع", "decision", "law", "legislation"],
     ...
     // قطاع القرار 104 والحوافز الاستثمارية
"قرار": ["104", "قرار 104", "حوافز", "اعفاءات", "مزايا", "استثمار", "قانون 72", "incentives"],
"حوافز": ["قرار", "104", "اعفاء ضريبي", "مزايا استثمارية", "قطاع أ", "قطاع ب", "تخفيض", "دعم"],
"قطاع": ["قطاع أ", "قطاع ب", "القطاع الاول", "القطاع الثاني", "sector", "A", "B"],
"استثمار": ["حوافز", "مزايا", "اعفاء", "قرار 104", "قانون الاستثمار", "investment"],

// الصناعات المشمولة بالقرار
"طاقة متجددة": ["خلايا شمسية", "هيدروجين اخضر", "طاقة رياح", "انفرتر", "بطاريات", "شحن كهربائي"],
"سيارات": ["سيارات كهربائية", "غاز طبيعي", "محركات كهربائية", "اسطوانات غاز", "شحن مركبات"],
"ادوية": ["مضادات حيوية", "ادوية اورام", "لقاحات", "مواد فعالة", "مستحضرات تجميل"],
"صناعات غذائية": ["خضراوات مجففة", "فواكه مجففة", "تمور", "زيوت نباتية", "مخلفات زراعية"],
"صناعات هندسية": ["تحلية مياه", "اجهزة الكترونية", "آلات معدات", "حاويات", "هواتف محمولة"],
"بتروكيماويات": ["بترول", "غاز طبيعي", "هيدروجين", "بتروكيماويات", "وقود حيوي", "اسمدة"],
"تعدين": ["خامات معدنية", "ذهب", "معادن", "تنقيب", "استخراج", "مسح جوي"],

// قطاع السياحة بالقرار
"فندق": ["فنادق", "شقق فندقية", "قرى سياحية", "ثلاث نجوم", "مارينا", "يخوت", "غوص", "جولف"],
"سياحة خضراء": ["بيئية", "نزل بيئية", "طيور", "تنوع بيولوجي", "طاقة كفاءة"],

// قطاع النقل بالقرار
"نقل بحري": ["حاويات", "سفن", "علم مصري", "موانئ", "شحن بحري"],
"لوجستي": ["موانئ جافة", "مراكز لوجستية", "مستودعات", "شحن تفريغ", "ميناء جاف"],
"سكك حديدية": ["قطارات", "سكك حديد", "مترو", "جر كهربي", "ورش صيانة"],
"نقل نهري": ["نيل", "موانئ نهرية", "مراسي", "حاويات نهرية", "صوامع غلال"],
"نقل مبرد": ["ثلاجات", "حاصلات زراعية", "مواد غذائية", "حاويات مبردة"],
"نقل جماعي": ["مجتمعات عمرانية", "مدن جديدة", "غاز طبيعي", "300 مقعد"],

// قطاع الزراعة بالقرار
"استصلاح": ["اراضي صحراوية", "ري حديث", "اراضي بور", "استزراع"],
"تربية حيوانات": ["الالبان", "سلالات", "دواجن", "ماشية"],

// قطاع الاتصالات بالقرار
"برمجة": ["تصميم برامج", "تطوير برامج", "تعهيد", "الكترونيات", "مراكز بيانات", "مراكز اتصال"],
